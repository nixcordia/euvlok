...
# This script assumes it is run from the root
INPUT_FILE="modules/hm/gui/chromium/extensions_list.txt"
OUTPUT_FILE="modules/hm/gui/chromium/extensions.nix"
...
# To update, edit ${INPUT_FILE} and run the update script from the repo root.
