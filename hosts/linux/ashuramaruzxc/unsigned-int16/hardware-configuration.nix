...
in
{
  ...
  boot = {
    tmp.useTmpfs = true;
    loader.raspberryPi.firmwarePackage = pkgs.linuxAndFirmware.v6_12_25.raspberrypifw;
  ...
  nixpkgs.overlays = lib.mkAfter [
    (self: super: {
      ...
      inherit (pkgs.linuxAndFirmware.v6_12_25) raspberrypiWirelessFirmware;
      # Some derivations want to use it as an input,
      # e.g. raspberrypi-dtbs, omxplayer, sd-image-* modules
      inherit (pkgs.linuxAndFirmware.v6_12_25) raspberrypifw;
    })
  ];
